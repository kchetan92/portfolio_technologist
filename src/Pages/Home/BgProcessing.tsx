...
const distanceBetweenPoints = 45;
...
class Point {
  ...
  draw(p5: p5Types) {
    ...
    if (distance > 400 && distance < 650) {
      ...
      const separationAngle = p5.map(distance, 400, 650, 0, p5.PI);
      ...
      p5.fill("rgb(124, 226, 209)");
      p5.circle(this.x + separationX, this.y + separationY, 3);
      p5.fill("rgb(170, 166, 235)");
      p5.circle(this.x - separationX, this.y - separationY, 3);
    } else {
      // p5.fill("rgb(220, 220, 220)");
